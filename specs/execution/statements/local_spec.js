...
describe("Reducing local X in ... end statements", () => {
  ...
  it("executes correctly when the sigma is empty", () => {
  ...
  it("executes correctly when there are previous variables in the sigma", () => {
    const state = buildState({
      threads: [buildThread()],
      sigma: buildSigma(
  ...
  it("executes incrementing the environment index", () => {
