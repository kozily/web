...
describe("Reducing raise statements", () => {
  ...
  it("executes correctly when there is a catch statement in the stack", () => {
  ...
  it("executes correctly incrementing the environemnt index", () => {
  ...
  it("throws an error when there is no catch statement on the stack", () => {
    ...
    expect(() => execute(state, statement, 0)).toThrowMatching(error => {
      return (
